...
export const showAPIConfigAlert = (navigation) => {
    Alert.alert(
        "Server error",
        error.message + ": The API endpoint is down",
        [
            {text: 'OK'},
            {
                text: "Configure",
...
export const getAPIUrlFromStorage = async () => {
    return await SecureStore.getItemAsync("APIUrl")
}
